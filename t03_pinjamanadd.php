...
<input type="text" data-table="t03_pinjaman" data-field="x_No_Ref" name="x_No_Ref" id="x_No_Ref" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($t03_pinjaman->No_Ref->getPlaceHolder()) ?>" value="<?php echo $t03_pinjaman->No_Ref->EditValue ?>"<?php echo $t03_pinjaman->No_Ref->EditAttributes() ?>>
</span>
