...
<?php if ($t04_pinjamanangsuran->pinjamantitipan_id->Visible) { // pinjamantitipan_id ?>
		<th><span id="elh_t04_pinjamanangsuran_pinjamantitipan_id" class="t04_pinjamanangsuran_pinjamantitipan_id"><?php echo $t04_pinjamanangsuran->pinjamantitipan_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($t04_pinjamanangsuran->pinjamantitipan_id->Visible) { // pinjamantitipan_id ?>
		<td<?php echo $t04_pinjamanangsuran->pinjamantitipan_id->CellAttributes() ?>>
<span id="el<?php echo $t04_pinjamanangsuran_delete->RowCnt ?>_t04_pinjamanangsuran_pinjamantitipan_id" class="t04_pinjamanangsuran_pinjamantitipan_id">
