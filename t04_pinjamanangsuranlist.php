...
<option value="10"<?php if ($t04_pinjamanangsuran_list->DisplayRecs == 10) { ?> selected<?php } ?>>10</option>
<option value="20"<?php if ($t04_pinjamanangsuran_list->DisplayRecs == 20) { ?> selected<?php } ?>>20</option>
...
<option value="200"<?php if ($t04_pinjamanangsuran_list->DisplayRecs == 200) { ?> selected<?php } ?>>200</option>
<option value="500"<?php if ($t04_pinjamanangsuran_list->DisplayRecs == 500) { ?> selected<?php } ?>>500</option>
...
<?php if ($t04_pinjamanangsuran->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t04_pinjamanangsuran->SortUrl($t04_pinjamanangsuran->id) ?>',2);"><div id="elh_t04_pinjamanangsuran_id" class="t04_pinjamanangsuran_id">
...
<?php if ($t04_pinjamanangsuran->pinjaman_id->Visible) { // pinjaman_id ?>
	...
	<?php } else { ?>
		<th data-name="pinjaman_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t04_pinjamanangsuran->SortUrl($t04_pinjamanangsuran->pinjaman_id) ?>',2);"><div id="elh_t04_pinjamanangsuran_pinjaman_id" class="t04_pinjamanangsuran_pinjaman_id">
