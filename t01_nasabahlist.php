...
<option value="500"<?php if ($t01_nasabah_list->DisplayRecs == 500) { ?> selected<?php } ?>>500</option>
...
<?php if ($t01_nasabah->No_Telp_Hp->Visible) { // No_Telp_Hp ?>
	...
	<?php } else { ?>
		<th data-name="No_Telp_Hp"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_nasabah->SortUrl($t01_nasabah->No_Telp_Hp) ?>',2);"><div id="elh_t01_nasabah_No_Telp_Hp" class="t01_nasabah_No_Telp_Hp">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t01_nasabah->No_Telp_Hp->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t01_nasabah->No_Telp_Hp->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t01_nasabah->No_Telp_Hp->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
